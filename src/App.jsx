    ...
    <main id="canvas" className="fondo w-screen h-screen bg-no-repeat bg-cover flex items-center justify-center bg-center ">
      {
        !valueSi ? (
          <div className="p-5">
            <h1 className="text-white font-bold text-5xl text-center">¿Quieres ser mi San Valentin esta noche amor?</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 mt-10 gap-5 items-center">
              ...
              >
                ...
                <span hidden>{document.title = Object.keys(randomValor).length === 0 ? "¿Quieres ser mi San Valentin esta noche amor?" : randomValor.description}</span>
              </button>
            </div>
          </div>
        ) : (
          <div className="flex justify-center items-center flex-col space-y-10">
            ...
            <h2 className="text-4xl text-white font-bold">❤️ Te quiero mucho Xiomara ❤️</h2>
            <img src="corazon.png" alt="Imagen con Marco de Corazón" class="rounded-full border-8 border-red-500 p-1"/>
